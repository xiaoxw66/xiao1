...
public class RandomValidateCodeUtil {
    ...
    private static final String randString_num = "0123456789";//随机产生只有数字的字符串 private String
    private static final String randString_str = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";//随机产生只有字母的字符串
    private static final String randString_num_str = "0ABC1DEF2GHI3JKL4MNO5PQR6STU7VWX8YZ9";//随机产生数字与字母组合的字符串
    ...
    public void getRandomCode(HttpServletRequest request, HttpServletResponse response) {
        ...
        log.info("生成的随机字符串为:{}", randomString);
    ...
    private String drowString(Graphics graphics, String randomString, int i) {
        ...
        String rand = String.valueOf(getRandomString(random.nextInt(randString_num_str.length())));
        randomString += rand;
    ...
    public String getRandomString(int num) {
        return String.valueOf(randString_num_str.charAt(num));
    }
}
